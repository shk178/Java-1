...
public class SimpleWorker2 extends Thread {
    ...
    public SimpleWorker2(Queue<String> jobQueue, String name) {
        super(name);
    ...
    public static void main(String[] args) {
        ...
        //스레드 3개 시작
        new SimpleWorker2(jobQueue, "워커a").start();
        new SimpleWorker2(jobQueue, "워커b").start();
        new SimpleWorker2(jobQueue, "워커c").start();
    }
}
/*
워커b: poll() 실행 - 현재 루프 i=0
워커c: poll() 실행 - 현재 루프 i=0
워커a: poll() 실행 - 현재 루프 i=0
...
워커c: 작업0(워커b가 추가) 처리 - 현재 루프 i=1
워커a: 작업0(워커a가 추가) 처리 - 현재 루프 i=1
워커b: 작업0(워커c가 추가) 처리 - 현재 루프 i=1
워커c: poll() 실행 - 현재 루프 i=2
워커a: poll() 실행 - 현재 루프 i=2
워커b: poll() 실행 - 현재 루프 i=2
워커c: 큐가 비어있음, CPU 양보 - 작업2를 큐에 추가
워커a: 큐가 비어있음, CPU 양보 - 작업2를 큐에 추가
워커b: 큐가 비어있음, CPU 양보 - 작업2를 큐에 추가
워커c: yield() 실행 - 현재 루프 i=2
워커a: yield() 실행 - 현재 루프 i=2
워커b: yield() 실행 - 현재 루프 i=2
워커c: poll() 실행 - 현재 루프 i=3
워커a: poll() 실행 - 현재 루프 i=3
워커b: poll() 실행 - 현재 루프 i=3
워커c: 작업2(워커c가 추가) 처리 - 현재 루프 i=3
워커c: poll() 실행 - 현재 루프 i=4
워커a: 작업2(워커a가 추가) 처리 - 현재 루프 i=3
워커b: 작업2(워커b가 추가) 처리 - 현재 루프 i=3
워커c: 큐가 비어있음, CPU 양보 - 작업4를 큐에 추가
워커a: poll() 실행 - 현재 루프 i=4
워커b: poll() 실행 - 현재 루프 i=4
워커b: 큐가 비어있음, CPU 양보 - 작업4를 큐에 추가
워커c: yield() 실행 - 현재 루프 i=4
워커a: 작업4(워커c가 추가) 처리 - 현재 루프 i=4
